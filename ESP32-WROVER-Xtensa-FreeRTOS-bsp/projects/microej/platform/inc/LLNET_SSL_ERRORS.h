...
#define J_CREATE_SSL_CONTEXT_ERROR				-1 /* SSL Context creation error */
#define J_CREATE_SSL_ERROR						-1 /* SSL creation error */
#define J_CONNECTION_RESET						-2 /* connection reset by the peer */
#define J_SOCKET_TIMEOUT						-3 /* socket timeout */
...
#define J_BIG_KEY_PASSWORD_SIZE_ERROR			-11 /* key password size bigger than the immortal buffer reserved for the keys passwords*/
...
#define J_ASYNC_INIT_ERROR      		       -80 /* Async Init error */
#define J_BAD_ALIGN_ERROR         		       -81 /* Bad alignment for operation no alloc */
#define J_BAD_STATE_ERROR     		       	   -82 /* Bad state operation */
...
#define J_VERIFY_FINISHED_ERROR               -104 /* verify problem on finished */
#define J_VERIFY_MAC_ERROR                    -105 /* verify mac problem       */
#define J_HEADER_PARSE_ERROR                  -106 /* parse error on header    */
#define J_UNKNOWN_HANDSHAKE_TYPE              -107 /* weird handshake type     */
#define J_SOCKET_ERROR                        -108 /* error state on socket    */
#define J_SOCKET_NODATA                       -109 /* expected data not there */
#define J_INCOMPLETE_DATA                     -110 /* don't have enough data to complete task */
#define J_UNKNOWN_RECORD_TYPE                 -111 /* unknown type in record hdr */
#define J_DECRYPT_ERROR                       -112 /* error during decryption  */
#define J_FATAL_ERROR                         -113 /* recvd alert fatal error  */
...
#define J_SSL_NO_PEM_HEADER                   -172 /* no PEM header found */
