...
/** @brief list of Wifi Client State constants */
#define WIFI_CLIENT_STATE_IDLE						(0)
#define WIFI_CLIENT_STATE_STARTED					(1)
...
/**
 * Get the state of the client side of the Wi-Fi.
 *
 * @param getResult
 *            false to post the request, true to get the result
 * @return {@link WifiClientStateNativeConstants#IDLE} or {@link WifiClientStateNativeConstants#STARTED} if success,
 * @see {@link LLNET_ERRORS} header file for error codes
 */
